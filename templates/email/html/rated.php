              ...
              <tbody>
                ...
                <tr>
                  <td style="padding:10px 4% 20px 0; font-size: 14px; line-height:1.5;">
                    Hi <?=!empty($appt['Tutor']['first_name']) ? $appt['Tutor']['first_name'].' '.$appt['Tutor']['last_name'] : 'there'?>,
                  </td>
                </tr>
                <tr>
                  <td>
                    <p>You just received a new rating & review from <?=empty($appt['student_first_name']) ? "the student": $appt['student_first_name']?>. Please login to view it ASAP</p>
                    <p>
